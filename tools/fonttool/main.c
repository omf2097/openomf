...
void display(sd_font *font, int _sc, const char *text) {
    ...
    // Init window
    SDL_Window *window =
        SDL_CreateWindow("Fonttool v0.1", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 320 * _sc,
...
int main(int argc, char *argv[]) {
    ...
    struct arg_file *export =
        arg_file0("e", "export", "<file>", "Export the full font to a PNG file");
    struct arg_lit *split =
        arg_lit0(NULL, "split", "Split to separate PNG files (set path in -e).");
