...
void bkanim_set_key(sd_bk_anim *bka, sd_animation *ani, const char **key, int kcount,
                    const char *value) {
...
int main(int argc, char *argv[]) {
    ...
    struct arg_int *sprite =
        arg_int0("s", "sprite", "<sprite_id>", "Select sprite (requires --anim)");
    ...
    struct arg_file *export =
        arg_file0(NULL, "export", "<file>", "Exports data to a file (requires --key)");
    struct arg_file *import =
        arg_file0(NULL, "import", "<file>", "Imports data from a file (requires --key)");
    struct arg_int *stencil =
        arg_int0(NULL, "stencil", "<int>", "Stencil index for image (requires --import)");
    ...
    void *argtable[] = {help,   vers,    file, new,   output, anim, all_anims,
                        sprite, keylist, key,  value, push,   pop,  export,
                        import, stencil, play, scale, parse,  end};
