 ...
 *
 * This header is the source of truth for all uses of the extended/expanded common colors.
 */
 ...
 *
 * This replaces colors used by the UI system.
 */
 ...
 *
 * The intent of this is to broaden the existing common colors, especially adding more skin tones
 * and greens.
 * */
