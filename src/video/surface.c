...
void surface_force_refresh(surface *sur) { sur->force_refresh = 1; }
...
int surface_get_type(surface *sur) { return sur->type; }
...
void surface_sub(surface *dst, surface *src, int dst_x, int dst_y, int src_x, int src_y, int w,
                 int h, int method) {
...
void surface_to_rgba(surface *sur, char *dst, screen_palette *pal, char *remap_table,
                     uint8_t pal_offset) {
...
int surface_to_texture(surface *src, SDL_Texture *tex, screen_palette *pal, char *remap_table,
                       uint8_t pal_offset) {
    void *pixels;
    int pitch;
