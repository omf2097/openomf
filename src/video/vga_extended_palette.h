...
/* ===== Base Palette Zones (0x000-0x0FF) — unchanged ===== */
...
/* ===== Extended Palette Zones (0x100-0x3FF) ===== */
 ...
 * Remapped from P2 zone (0x30-0x5F) and part of BG zone. */
#define VGA_EXT_P1_HAR_START       0x10C
#define VGA_EXT_P1_HAR_END         0x16B  /* 96 colors: 3ch x 32 hues */

/* P1 HAR detail: 16 auto-generated colors derived from pilot base colors.
 * Desaturated, heat, cold, accent operations. */
#define VGA_EXT_P1_DETAIL_START     0x16C
#define VGA_EXT_P1_DETAIL_END       0x17B  /* 16 colors */

/* P2 HAR player extended: same structure as P1, for player 2. */
#define VGA_EXT_P2_HAR_START       0x17C
#define VGA_EXT_P2_HAR_END         0x1DB  /* 96 colors: 3ch x 32 hues */

/* P2 HAR detail: same structure as P1 detail, for player 2. */
#define VGA_EXT_P2_DETAIL_START     0x1DC
#define VGA_EXT_P2_DETAIL_END       0x1EB  /* 16 colors */

/* Scene extended: 96 colors for backgrounds, overlays, hazards.
 * Populated per scene from BK data. */
#define VGA_EXT_SCENE_START        0x1EC
#define VGA_EXT_SCENE_END          0x24B  /* 96 colors */
