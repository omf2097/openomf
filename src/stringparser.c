...
static const sd_stringparser_tag_info tags[] = {
    ...
    {"ms",  0, NULL},
    {"mu",  1, NULL},
    {"mx+",  1, "X position of new animation, relative to current one"},
    {"mx-",  1, "X position of new animation, relative to current one"},
    {"mx",  1, "X position of new animation, absolute coordinate"},
    {"my+",  1, "Y position of new animation, relative to current one"},
    {"my-",  1, "Y position of new animation, relative to current one"},
    {"my",  1, "Y position of new animation, absolute coordinate"},
