...
static const button_details details_list[] = {
    {NULL, "SELECT", TEXT_HORIZONTAL, TEXT_CENTER, TEXT_MIDDLE, 0, 0, 0, 0, COM_ENABLED},
    {NULL, NULL,     TEXT_HORIZONTAL, TEXT_CENTER, TEXT_MIDDLE, 0, 0, 0, 0, COM_ENABLED},
    {NULL, NULL,     TEXT_HORIZONTAL, TEXT_CENTER, TEXT_MIDDLE, 0, 0, 0, 0, COM_ENABLED},
};

component *lab_menu_tournament_create(scene *s, dashboard_widgets *dw) {
    ...
    component *label = label_create(&tconf, "SELECT A TOURNAMENT YOU WISH TO ENTER");
