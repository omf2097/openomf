...
void vs_render(scene *scene) {
    ...
    if(player2->selectable) {
        ...
        text_settings dark_text;
        text_defaults(&dark_text);
        dark_text.font = FONT_SMALL;
        dark_text.cforeground = TEXT_DARK_GREEN;
        ...
        text_render(&dark_text, TEXT_DEFAULT, 190, 16, 120, 6, "WINNINGS:");
        ...
        text_render(&dark_text, TEXT_DEFAULT, 184, 100, 120, 6, "HIT/MISS RATIO:");
        ...
        text_render(&dark_text, TEXT_DEFAULT, 184, 137, 120, 6, "HIT/MISS RATIO:");
