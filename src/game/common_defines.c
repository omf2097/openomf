...
const char *pilot_type_names[] = {"CRYSTAL",  "STEFFAN",   "MILANO",   "CHRISTIAN",
                                  "SHIRRO",   "JEAN-PAUL", "IBRAHIM",  "ANGEL",
                                  "COSSETTE", "RAVEN",     "KREISSACK"};
...
const char *scene_type_names[] = {
    ...
    "SCENE_ARENA3", "SCENE_ARENA4",     "SCENE_NORTHAM", "SCENE_KATUSHAI", "SCENE_WAR",
    "SCENE_WORLD",  "SCENE_SCOREBOARD",
};

int rand_arena() { return SCENE_ARENA0 + rand_int(5); }
...
int har_to_resource(unsigned int id) { return AF_JAGUAR + id; }
