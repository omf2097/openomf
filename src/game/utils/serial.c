...
// taken from
// http://stackoverflow.com/questions/10620601/portable-serialisation-of-ieee754-floating-point-values
...
void serial_write_int8(serial *s, int8_t v) { serial_write(s, (char *)&v, sizeof(v)); }
...
size_t serial_len(serial *s) { return s->wpos; }

void serial_read_reset(serial *s) { s->rpos = 0; }
