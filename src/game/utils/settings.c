...
const field f_keyboard[] = {
    ...
    F_STRING(settings_keyboard, key1_jump_up,    "W"),
    F_STRING(settings_keyboard, key1_jump_right,  "E"),
    F_STRING(settings_keyboard, key1_walk_right,  "D"),
    F_STRING(settings_keyboard, key1_duck_forward, "C"),
    F_STRING(settings_keyboard, key1_duck,    "X"),
    F_STRING(settings_keyboard, key1_duck_back,  "Z"),
    F_STRING(settings_keyboard, key1_walk_back,  "A"),
    F_STRING(settings_keyboard, key1_jump_left, "Q"),
    ...
    F_STRING(settings_keyboard, key2_jump_up,    "Up"),
    F_STRING(settings_keyboard, key2_jump_right,  "PageUp"),
    F_STRING(settings_keyboard, key2_walk_right,  "Right"),
    F_STRING(settings_keyboard, key2_duck_forward, "PageDown"),
    F_STRING(settings_keyboard, key2_duck,    "Down"),
    F_STRING(settings_keyboard, key2_duck_back,  "End"),
    F_STRING(settings_keyboard, key2_walk_back,  "Left"),
    F_STRING(settings_keyboard, key2_jump_left, "Home"),
