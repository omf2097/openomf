...
const field f_sound[] = {
    F_STRING(settings_sound, sink, "openal"),      F_BOOL(settings_sound, music_mono, 0),
    F_INT(settings_sound, sound_vol, 5),           F_INT(settings_sound, music_vol, 5),
    F_INT(settings_sound, music_frequency, 44100),
#if USE_DUMB
    F_INT(settings_sound, music_library, 1),       F_INT(settings_sound, music_resampler, 2),
#elif USE_XMP
    F_INT(settings_sound, music_library, 2),       F_INT(settings_sound, music_resampler, 1),
#endif
    F_STRING(settings_sound, music_arena0, ""),    F_STRING(settings_sound, music_arena1, ""),
    F_STRING(settings_sound, music_arena2, ""),    F_STRING(settings_sound, music_arena3, ""),
    F_STRING(settings_sound, music_arena4, ""),    F_STRING(settings_sound, music_end, ""),
    F_STRING(settings_sound, music_menu, "")};

const field f_gameplay[] = {
    F_INT(settings_gameplay, speed, 5),       F_INT(settings_gameplay, fight_mode, 0),
...
const field f_keyboard[] = {
    ...
    F_STRING(settings_keyboard, joy_name1, "None"), F_INT(settings_keyboard, joy_offset1, -1),
    ...
    F_STRING(settings_keyboard, joy_name2, "None"), F_INT(settings_keyboard, joy_offset2, -1),
    ...
    F_STRING(settings_keyboard, key2_duck, "X"), F_STRING(settings_keyboard, key2_duck_back, "Z"),
...
int *fieldint(void *st, int offset) { return (int *)((char *)st + offset); }
double *fieldfloat(void *st, int offset) { return (double *)((char *)st + offset); }
char **fieldstr(void *st, int offset) { return (char **)((char *)st + offset); }
int *fieldbool(void *st, int offset) { return fieldint(st, offset); }
...
settings *settings_get() { return &_settings; }
