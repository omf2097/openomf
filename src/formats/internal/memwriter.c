...
long memwriter_pos(const memwriter *writer) { return writer->data_len; }
...
void memwrite_ubyte(memwriter *writer, uint8_t value) { memwrite_buf(writer, (char *)&value, 1); }

void memwrite_uword(memwriter *writer, uint16_t value) { memwrite_buf(writer, (char *)&value, 2); }

void memwrite_udword(memwriter *writer, uint32_t value) { memwrite_buf(writer, (char *)&value, 4); }

void memwrite_byte(memwriter *writer, int8_t value) { memwrite_buf(writer, (char *)&value, 1); }

void memwrite_word(memwriter *writer, int16_t value) { memwrite_buf(writer, (char *)&value, 2); }

void memwrite_dword(memwriter *writer, int32_t value) { memwrite_buf(writer, (char *)&value, 4); }
