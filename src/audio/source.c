...
void source_init(audio_source *src) { memset(src, 0, sizeof(audio_source)); }
...
void source_set_userdata(audio_source *src, void *userdata) { src->userdata = userdata; }

void *source_get_userdata(audio_source *src) { return src->userdata; }

void source_set_update_cb(audio_source *src, source_update_cb cbfunc) { src->update = cbfunc; }

void source_set_close_cb(audio_source *src, source_close_cb cbfunc) { src->close = cbfunc; }
